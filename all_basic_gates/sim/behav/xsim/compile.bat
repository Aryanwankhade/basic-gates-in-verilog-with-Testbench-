...
REM
REM Generated by Vivado on Sat Feb 28 13:13:10 +0530 2026
...
echo "xvlog --incr --relax -prj all_basic_gates_verilog_vlog.prj"
call xvlog  --incr --relax -prj all_basic_gates_verilog_vlog.prj -log xvlog.log
